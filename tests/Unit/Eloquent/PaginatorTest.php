...
{
    /** @test */
    public function next_page_url_with_no_further_pages()
    {
    ...
    /** @test */
    public function next_page_url_with_further_pages()
    {
    ...
    /** @test */
    public function path_should_return_the_current_url()
    {
        $instance = $this->paginator();

        $this->assertEquals(request()->url(), $instance->testPath());
    }

    /** @test */
    public function previous_page_url_with_no_further_pages()
    {
        $instance = $this->paginator();
    ...
    /** @test */
    public function previous_page_url_with_further_pages()
    {
    ...
    /** @test */
    public function url_should_not_have_negative_number_or_zero()
    {
        $instance = $this->paginator();
    ...
    /** @test */
    public function url_should_reuse_the_already_existing_query_parameters()
    {
    ...
    /** @test */
    public function to_array_should_return_array_response()
    {
        $instance = $this->paginator();
    ...
    /** @test */
    public function json_serialize_is_just_wrapper_for_to_array()
    {
        $instance = $this->paginator();
    ...
    /** @test */
    public function to_json_should_make_json_string()
    {
        $instance = $this->paginator();
    ...
    protected function collection(int $count = 10)
    {
        $array = [];
    ...
    protected function paginator(Collection $collection = null, int $perPage = 15, int $currentPage = null)
    {
        ...
        return new PaginatorTestWrapper(
            new LengthAwarePaginator($collection, $collection->count(), $perPage, $currentPage), request()
        );
    }
}